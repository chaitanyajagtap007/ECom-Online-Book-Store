...
import com.mh.crj.filter.AppFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/userlogin", "/userregisters").permitAll()
                .requestMatchers("/getAllUsers", "/getAllBooks" ,"/saveBook", "/deleteBook/**").authenticated()
